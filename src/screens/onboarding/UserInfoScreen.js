...
const UserInfoScreen = ({ navigation, route }) => {
  ...
  const handleNext = useCallback(async () => {
    try {
      if (isEditing) {
        ...
        navigation.navigate('WorkoutPreference', { userData: formData });
      }
    } catch (error) {
  ...
  const isFormValid = formData.name && formData.age && formData.height && formData.weight && formData.gender;
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.header}>
          <Text style={styles.title}>
            {isEditing ? 'Edit Profile' : 'Tell us about yourself'}
          </Text>
          {isEditing && (
            <TouchableOpacity 
        ...
        <View style={styles.footer}>
          ...
          {!isFormValid && (
            <Text style={styles.instructionText}>Please fill in all fields to continue</Text>
          )}
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
